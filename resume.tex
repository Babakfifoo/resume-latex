...
\section{GIS specialist | Data analytics engineer}
\small{
...
\begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
  \textbf{Spatial data | GIS:}      &   \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$ }& &
  ...
  \textbf{PostgreSQL | PostGIS:}& \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $ }\WS{3/5,}& &
...
{Apex-Heat -- Finland}
\resumeItemListStart{}
\resumeItem{Consulting on data transformation and business logic to facilitate future integration of \textbf{spatial data} with third-party systems.}
\resumeItem{Developing a data pipeline to transform and compute key metrics from \textbf{building spatial data} across Finland.}
\resumeItem{Designing and implementing an \textbf{API-based pipeline} for automated building calculations in Finland.}
\resumeItem{Evaluating and structuring \textbf{spatial data models} for EU-wide coverage.}
...
\resumeItem{Acquiring \textbf{GIS data} from \textbf{REST} and \textbf{ArcGIS Online} endpoints in the Netherlands to construct a longitudinal panel dataset for research.}
