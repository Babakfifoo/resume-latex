...
\titleformat{\section}
{\large\bfseries}{}
{0em}{\textcolor[HTML]{33a34e}}[\color{black}\titlerule\vspace{0pt}]
%-------------------------------------
...
%--------------Technical Skills
	\section{Technical Skills}
		\begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
			...
			\textbf{STATA:} & $\CIRCLE \CIRCLE \CIRCLE \CIRCLE \Circle$ & &
			\\ 
	...
	\begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
		...
		\\
		\textbf{Quantiative research:} & $\CIRCLE \CIRCLE \Circle \Circle \Circle$ & &
		\textbf{Prompt engineering:} & $\CIRCLE \CIRCLE \CIRCLE \CIRCLE \Circle$ & &
		& 
		\\
