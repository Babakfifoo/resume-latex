...
\begin{document}
	...
	\small{
		An adaptable and results-driven problem-solver with a solid foundation in IT, software development, customer service, and B2B business. My extensive experience across diverse industries is a direct result of my strong problem-solving skills and an ever-growing desire to learn and grow, allowing me to approach new challenges with a broad perspective and a passion for innovation.
	}
	%--------------------------------------------
...
%	\resumeHeadingListEnd{}
	...
	\resumeItem{Designed and deployed database in PostgreSQL and DuckDB data lake for research data in our team.}
	\resumeItem{Preparing and updating visualisations for lecture and presentation.}
	\resumeItem{Performing \textbf{time-to-event} statistical modelling for my research using parametric, semi-parametric and non-parametric models. These models include \textbf{longitudinal data}, \textbf{repeating event}, \textbf{multi-state} and joint models.}
	...
	\resumeItemListStart{}
	\resumeItem{Designing data pipeline to gather data form REST APIs, cleaning, Geo-coding and storing in accordance to the specifications requested by clients}
	\resumeItem{Creating Spatial data dashboard for spatial network analysis back-end. The analysis used HSL, HERE and HSY APIs to gather and process the data and perform network analysis.}
	\resumeItemListEnd{}
	\noindent\rule{0.5\linewidth}{0.4pt}
	...
	\resumeItemListStart{}
	\resumeItem{Performing Spatial Data analysis, Processing and storing spatial.}
	...
	\resumeItem{Preparing analysis, graphs, maps and data visualisations for stakeholders, projects managers and clients.}
	\resumeItem{Providing GIS analysis to transport engineers, landscape designers, urban planners and architects.}
	...
	\resumeItem{Provided in house graphic design, CAD and technical solutions for clients.}
...
%	\resumeHeadingListEnd{}
	...
	% 	\\
	% 	\textbf{longitudinal data:} & $\CIRCLE \CIRCLE \CIRCLE \CIRCLE \Circle$ & &
