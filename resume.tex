...
\definecolor{accent_text}{HTML}{f2a6a6}
...
\section{Real Estate Economist | Data Analyst | Data Engineer}

  \small{
  PhD student in real estate economics with strong background in data analytics, econometrics and data science. I have performed extensive research in land policy, processed and generated reports on property listings, transactions and land use plans. I have worked as consultant, collaborated with planners and retail experts in WSP Finland Oy. I have also worked with researchers at real estate econics faculty.
  }
