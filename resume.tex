...
\section{Quantitative Analyst $|$ Data Engineer $|$ Researcher}
\small{
  Researcher with a strong analytical focus who has spent several years in academic settings conducting quantitative research. I have a comprehensive understanding of time series analysis, survival models, spatial data analysis, and econometric modeling, and I have gained experience in all stages of the data lifecycle, from data collection and processing to analysis and interpretation. Adept at translating complex statistical results into clear, actionable insights. I am currently seeking to leverage my solid background in research and modeling in a quantitative risk or data-focused industry role.
}
%--------------------------------------------
