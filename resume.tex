...
\section{Analyst $|$ Researcher $|$ Generalist}
\small{
Data analytics engineer and doctoral candidate with over six years of expertise in academic and consulting settings developing comprehensive ETL/ELT pipelines, econometric models, and solutions for geographical data. I have extensive experience in real estate economics and urban planning in addition to my technical skills in Python, PostgreSQL, DuckDB, and cloud platforms. This allows me to analyze complicated datasets and provide clients and stakeholders with insights that are suitable for decision-making.
}
%--------------------------------------------
...
Providing a wide variety of data engineering, analytics, and BI services based on in-depth knowledge of client's industry and other specific needs. Consulting on business rationale with an eye toward growth.
As an expert in ETL/ELT procedures, I can efficiently process and parse a wide variety of data types, and I always provide clients with results that are easy to understand and in line with their goals.

\resumeQuadHeadingChild{Building information backend} {Jan 2026 -- Present}
{Apex-Heat -- Finland}

\resumeItemListStart{}
\resumeItem{Consulting the transformation of data and business logit to improve future integration of the data and the API with other systems.}
...
\resumeItem{Developing \textbf{API based pipline} for building calculations in Finland.}
\resumeItem{Assessing and structuring the data models for EU countries.}
\resumeItem{Modelling data based on the domain knowledge in real esate economics, and zoning laws}
\resumeItemListEnd{}
...
Researching housing markets, real estate development, and urban planning utilizing econometric and machine learning techniques as part of a doctoral program in urban and real estate economics. Overseeing the entire data lifecycle of a research project, including collecting, processing, analyzing, and visualizing the data, while also providing IT support and building the data infrastructure for the entire team.
...
{Aalto University}  {Full-time -- Espoo, Finland}
Contributed to an Agent Based Modelling (ABM) research project simulating urban mobility and parking pressure, working in collaboration with MIT CityLab.
...
Worked part-time at an urban analytics startup, delivering data engineering and spatial analysis solutions for clients in the urban planning and sustainability space.
...
Provided GIS and spatial data analysis support across a range of urban planning and transport projects, delivering insights and visualisations to multidisciplinary teams and external clients.
...
Led day-to-day operations of a manufacturing business, overseeing financial management, client relations, production coordination, and technical delivery across a broad range of operational functions.
