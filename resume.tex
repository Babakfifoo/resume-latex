...
\begin{document}
	...
	\small{
		Highly analytical Geospatial Data Engineering expert and Ph.D. Candidate with extensive experience in designing, optimizing, and deploying complex data solutions. My expertise includes GIS analysis, spatial network modeling, extracting structured data using RAG, and performing econometric and time-to-event statistical modeling. I have successfully engineered efficient data pipelines, optimized SQL queries, resolved technical debt, and improved performance through migration (Pandas to Polars). I am proficient in Python, R, and SQL with experience of creating data visualizations and utilizing econometric and machine learning models.
	}
	%--------------------------------------------
...
%	\resumeHeadingListEnd{}
	...
	\resumeItem{implementing simualtions in GAMA Platform software}
	\resumeItemListEnd{}
	\noindent\rule{0.5\linewidth}{0.4pt}
