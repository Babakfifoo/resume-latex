...
\begin{document}
	...
	\small{
		I am a service-minded, flexible and curious problem solver who can master new abilities and adjust to new environments. I have abundance of experience with spatial data, GIS, econometrics, statistics, and data science utilising R, Python, Julia, and SQL. My main strength lies in contiouse learning, and adjust to diverse ways of working.
	}
	%--------------------------------------------
