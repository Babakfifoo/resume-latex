...
<<<<<<< HEAD
\definecolor{accent}{HTML}{6fbcc7}
=======
\definecolor{accent}{HTML}{043E36}
>>>>>>> ea6e010b527bf4fc1fe304b4fa01b7b01038b968
...
\begin{document}
  ...
  \hypersetup{
    ...
    pdfkeywords={self-driven, motivated, data analyst, data scientist, domain expert, economics, data visualisation, graphic design, machine learning}
  }
  ...
  \noindent
\begin{minipage}[t]{0.75\textwidth} % Text takes up 75% of the width
...
\end{minipage}%
\begin{minipage}[t]{0.25\textwidth} % Image takes up 25% of the width
			\flushright
		\begin{tikzpicture}[remember picture, overlay]
		\node[anchor=north east, xshift=0cm, yshift=0.5cm] at (current page.north east) {
			\begin{tikzpicture}
				% 1. Create a clipping path
				\path[clip] (-1.5,-1.5) rectangle (3cm,3cm);
				
				% 2. Center the image inside that path
				% 'anchor=center' ensures the middle of your photo is at (0,0)
				\node[anchor=center] at (0,0) {%
					\includegraphics[width=3cm, height=3cm, keepaspectratio]{profile_.jpeg}%
				};
			\end{tikzpicture}
		};
	\end{tikzpicture}
...
\end{minipage}
  ...
  % Keep this short, simple and straigth to point
    \section*{Data Analytics Engineer $|$ Data Engineer}
    \small{
I see data as a river flow, which we experts in the realm of data change its path and direction. I'm a problem solver who takes pride in being adaptable and eager to learn new skills. My background includes spatial data, GIS, econometrics, statistics, and data science, and I'm continuously expanding my knowledge in data processing and visualisation. I strive to develop analytical solutions for various challenges, and I'm keen to pursue opportunities that will allow me to grow further in data engineering and data science.
    }
	%--------------------------------------------
	...
	\section{Data Analytics Engineer $|$ Data Engineer $|$ Researcher}
	\small{
		I am a service-minded, flexible and curious problem solver who can master new abilities and adjust to new environments. I have mastered time-series and time related statistical and machine learning models. I am service minded and can effectively provide data analysis, solutions and insights for the business needs. I leverage my experience in production environment, can-do attitude and fast learning capabilities to adapt to any environemnt, produce tailor made solutions with high quality standards, and deliver results in a timely manner. I have a strong foundation in data science, machine learning, econometrics and statistical modelling which I apply to solve complex problems.
	}
	%--------------------------------------------
...
%--------------SKILLS------------------------
  ...
  \section{Technical Skills}
    \begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
      ...
      \textbf{Econometric:}        & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }\WS{4/5,}& &
      \textbf{Data Viz.:}          & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$ }\WS{5/5,}& &
      ...
      \textbf{LLM/NLP:}            & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }\WS{4/5,}& &
      \textbf{Feature Extraction:}& \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }\WS{4/5,}& &
      \textbf{AI Agents:}          & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$ }\WS{5/5,}& &
      \\ 
...
%  \resumeHeadingListEnd{}
  %--------------------------------------------
	...
	offer an extensive range of data engineering, analytics, and business intelligence services tailored to your needs. With a focus on spatial data, urban environments, and the complexities of the built environment, I ensure that my expertise translates into actionable insights.
	Specialising in ETL/ELT processes, I adeptly parse and process diverse data types, presenting results that are not only clear but also aligned with your objectives.
	...
	\resumeItemListStart{}
	\resumeItem{Producing data pipline to transform and calculate necessary measures of \textbf{buildings spatial data} in Finland}
	\resumeItem{Developing API based pipline for building calculations in Finland.}
	\resumeItem{Assessing and structuring the data models for EU countries.}
	\resumeItemListEnd{}

	\resumeQuadHeadingChild{Optimisation, technical debt} {Jan 2025 -- Dec 2025}
	{Apex-Heat -- Finland}


	\resumeItemListStart{}
	\resumeItem{Resolving \textbf{technical debt}. Improving the efficiency of the data pipelines.}
	...
	\resumeItemListStart{}
	% \resumeItem{Conducting research on housing development and housing market.}
	% \resumeItem{performing econometrics, hedonic regression and statistical analysis on property markets, real estate and housing develoipment.}
	...
	\resumeItem{ETL/ELT processes with data stewardship duties to acquire, maintain and provide research data.}
	\resumeItem{Self-taught programming skills, and further obtained formal education in data science.}
	\resumeItemListEnd{}
	

  \resumeQuadHeadingChild{Optimisation Project} {Jan 2025 -- Mar 2025}
  {Apex-Heat}  {Espoo, Finland}
  \resumeItemListStart{}
  \resumeItem{Resolving \textbf{technical debt}. Improving the efficiency of the data pipelines.}
  \resumeItem{Migrating from \textbf{Pandas} to \textbf{Polars} to improve the efficiency and calculation time.}
  \resumeItem{Improving the design pattern, and \textbf{writing documentations}.}
	\resumeItem{Retaining proper vesion control to smooth migration to Polars}
  \resumeItem{Adjusting an improving data processing test coverage and \textbf{testing} methods.}
  \resumeItem{\textbf{Optimising} the SQL queries to improve response time.}
	\resumeItem{Resolving the technical debt in the data pipeline codebase.}
  \resumeItemListEnd{}

  \resumeQuadHeadingChild{Building Database} {Dec 2025 -- Present}
  {Apex-Heat}  {Espoo, Finland}
  \resumeItemListStart{}
  \resumeItem{Acquiring and processing building data from Finland}
	\resumeItem{Modelling and enhancing the building data models in the pipeline}
	\resumeItem{Expnding data coverage to include additional countries (Sweden, Norway, Netherlands)}
	\resumeItem{Designing and implementing connection to Finnish building data API (Ryhti)}
  \resumeItemListEnd{}
  ...
  \resumeItem{Setting up ArcGIS Online platroms for \textbf{maritime} planning.}
  ...
  \resumeItemListStart{}
  \resumeItem{\textbf{Accounting}, cost calculation, financial analysis, human resources and BI}
  ...
  \resumeItem{Auditing, accounting, process and inventory management.}
