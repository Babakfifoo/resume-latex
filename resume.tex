...
\begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
  \textbf{Python:}              & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $ }& &
  \textbf{PostgreSQL:}          & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $ }& &
  \textbf{DuckDB:}              & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{SQL:}                 & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $ }& &
  \\
  
  \textbf{Spatial data:}        & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$ }& &
  \textbf{LLM/NLP/LLM:}         & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{SQLite:}              & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $ }& &
  \textbf{AZURE:}               & \textcolor{accent}{$\CIRCLE \CIRCLE   $ }& &
  \\
  
  \textbf{GCP:}                 & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{R:}                   & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ } & &
  \textbf{MongoDB:}             & \textcolor{accent}{$\CIRCLE \CIRCLE   $ }& &
  \textbf{Excel:}               & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \\
  
  \textbf{AcrGIS:}              & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{ETL/ELT:}             & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{Cartography:}         & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{STATA:}               & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $ }& &
  \\
  
  \textbf{Git:}                 & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE $ }& &
  \textbf{RAG:}                 & \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$ }& &
  \textbf{Julia:}               & \textcolor{accent}{$\CIRCLE \CIRCLE   $ }& &
  \textbf{PowerBI:}             & \textcolor{accent}{$\CIRCLE \CIRCLE $ }& &
  \\
...
\begin{tabular*}{\textwidth}{r@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}lcr@{\extracolsep{\fill}}l}
  \textbf{Team work:}&            \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $}& &
  \textbf{Self-organised:}&       \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE  $}& &
  \textbf{Project management:}&   \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $}
  \\
  \textbf{Accounting:}&           \textcolor{accent}{$\CIRCLE \CIRCLE   $}& &
  \textbf{Quality control:}&      \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $} & &
  \textbf{Visual communication:}& \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE \CIRCLE$} 
  \\
  \textbf{Quantiative research:}& \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $} & &
  \textbf{Prompt engineering:}&   \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $} & &
  \textbf{Document Management:}&  \textcolor{accent}{$\CIRCLE \CIRCLE \CIRCLE \CIRCLE $} & &
  \\
