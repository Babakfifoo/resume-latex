...
\begin{document}
	...
	\small{
		A highly skilled, service-minded and motivated Data Analyst holding a Ph.D. with over three years of experience in leveraging advanced analytics to turn complex datasets into analysis and process oriented insights. Proficient in Python, R, and SQL for data enhancement and processing, with a solid background in data management and database design, I have a proven experience of creating data visualizations and utilizing econometric and machine learning models. As a hands-on problem-solver, I am accustomed to working independently and collaborating with teams to deliver technical support .
	}
	%--------------------------------------------
