...
\begin{document}
	...
	\small{
Data analytics professional with a strong background in data engineering, statistical modeling, and visualization. Experienced in designing data pipelines, optimizing SQL queries, and creating reports and dashboards. Eager to apply my skills in a collaborative environment and learn new technologies to turn data into actionable insights that drive business value.
	}
	%--------------------------------------------
