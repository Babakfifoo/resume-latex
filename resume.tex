...
\begin{document}
	...
	\small{
		A highly skilled and motivated data analyst holding a Ph.D. in the built environment, with over three years of experience in data analytics, specialising in environmental and urban planning. Proficient in econometric and machine learning models, I have a proven track record of processing complex datasets and creating insightful data visualisations. As a problem-solver with a solid background in SQL, spatial econometrics, and database design, I am accustomed to working independently while providing technical support to achieve impactful results in emission control and environmental sustainability.
	}
	%--------------------------------------------
