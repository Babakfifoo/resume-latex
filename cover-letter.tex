...
I am one of the potential Bobs you are looking for!

I am a generalist who can specialise in whatever you need. I like solving problems first, and the domain second. During my experiences in manufacturing, consulting, and research, I have always adapted to the clients' and stakeholders' needs. I used my skills creatively to address challenges. For instance, I used Adobe Illustrator to trace a map and then project the map into real coordinates.

I prioritise work ethics and transparency. I once turned a client down when they requested a website scraping bot that gathered information once a month. I told them that the cost will significantly surpass what online tools can offer, and they will be better off using those SaaS services than mine. Further, another client of mine, whose efficiency of the data pipeline I improved, thanked me when they could use Claude to improve their code further since I added proper documentation everywhere.

I find a diversity of services NoA offering intriguing. My education may not fit well with NoA, and that is why I am interested, because at least I can learn more and look from a different perspective. Further, NoA seems like a place where I will encounter interesting tasks and problems and never get bored.

I have a Bob in me, and I hope you can see that and like my inner Bob. Looking forward to meeting you and telling you my story in person.
