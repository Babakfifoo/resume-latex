...
I was immediately drawn to the Product Analyst role at Smartly (as I applied before). The opportunity to collaborate closely with product management, design, and leadership to build something meaningful from the ground up is precisely the kind of work I am looking for.

I've designed ETL pipelines, built dashboards for diverse stakeholders, and modelled data in PostgresSQL and DuckDB across both research and commercial projects. At Qissa, a small urban analytics startup, I built an analytics dashboard integrating multiple APIs for client decision-making, the kind of cross-functional, product-facing work this role involves. In my current consulting work I've also tackled technical debt, improved pipeline performance, and written the documentation that makes data products maintainable long-term.

My research background in econometrics, data processing, and consulting ensures a rigorous approach to defining and interpreting metrics. My doctoral education prepared me to learn, adapt and continuously update my knowledge regarding any field I wished for. Therefore, I can design, produce and communicate KPIs that are out of the box. 

I'm pleased to come into the Helsinki office and would love to chat more about this position.
