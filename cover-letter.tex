...
Dear Basware hiring team,

Subject: Application for Data Scientist (LLM/ML Focus)  

I am excited to apply for the Data Scientist position at Basware, as advertised on Duunitori. My experience as a Data Analytics Engineer and Ph.D. Candidate aligns well with your needs for expertise in Large Language Models (LLM) and practical application of data science methodologies. At Aalto University and with Apex-Heat, I tackled challenges such as enhancing data pipeline efficiency and implementing generative AI solutions in the form of feature extraction, translation using LangChain, Hugging Face and local LLMs. 

I have a strong technical background in LLM development, with high proficiency in Retrieval-Augmented Generation (RAG), vector databases, and prompt engineering. My hands-on experience includes engineering data pipelines and optimising performance through systems migrations. Basware's emphasis on collaboration and best practices in LLM safety and AI ethics is intriguing to me. With my written and visual communication skills and project management experience, I can effectively translate complex technical concepts to diverse stakeholders. I look forward to discussing how I can contribute to Basware’s AI initiatives.
