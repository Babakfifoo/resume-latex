...
I am writing to express my keen interest in the Research Analyst position at Quantify Research. My recently completed PhD from Aalto University has provided me with a robust foundation in quantitative research that aligns well with your requirements for a statistician. Throughout my doctoral research, I developed advanced analytical skills in complex statistical analyses and econometric modelling on large-scale datasets. Although my research focused on real estate, I employed biostatistical models to study survival probabilities, longitudinal data, and multi-state models. I am proficient in statistical programming, including R, STATA, Python, and Julia, which I have used to design and deploy data lakes, optimise processing pipelines, and create visualisations.

My professional experience further underscores my readiness to serve as a flexible, service-minded and solutions-orientated consultant within your team. My previous roles involved close collaboration with cross-functional teams and clients, including delivering spatial data analysis at WSP Finland and preparing, storing and delivering research data to my research team at Aalto University. This experience has refined my ability to work effectively, independently, and on multiple projects simultaneously while ensuring clear communication of complex results to both internal and external stakeholders. I am eager to apply my analytical rigour and proactive approach to Quantify's mission of enhancing healthcare.
