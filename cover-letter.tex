...
I'm a PhD student in urban and real estate economics, and I'm currently trying to get an internship as a data analyst at IQM. As someone who loves technology, I'm really interested in IQM's technology and the new services you offer to the industry. I really like self-service and on-premise computing because I have some doubts about cloud-based solutions, especially when it comes to data security and following privacy rules and regulations.

I use econometric and machine learning techniques to solve problems with spatial data. This lets me combine careful analysis with useful information. I have hands-on experience managing the entire data lifecycle, from designing data infrastructure and writing SQL extraction workflows to building dashboards and sharing results with both technical and non-technical audiences. My background in urban planning and visual communication helps me present visualisations, analyses, and insights in a way that is clear, simple, and interesting.

By asking the right questions and understanding what stakeholders need, I can turn vague needs into clear, actionable data projects. I help my team members who aren't technical with this kind of work all the time. I know how to use Python, R, and SQL well, and I've made visualisations that make complicated patterns easier to understand. My work with spatial data and real estate economics has helped me get better at finding important signals in messy datasets and presenting them in ways that make it easier to make decisions.

I like IQM because the job fits my strengths perfectly: structured analytical thinking, working with stakeholders, and making data easy to understand for people who need to use it. I think it's exciting to be able to help a team that is at the cutting edge of technology while also working on scalable data and reporting workflows.
